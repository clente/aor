...
#
# You try contacting the Elves using your handheld device^[When you look
...
input <- "/12_hill_climbing_algorithm/input.txt"

# Once you're done with part 1, run the following line to fetch part 2:
aor::day_continue("2022-12-12", "/12_hill_climbing_algorithm/puzzle.R")
